...
public class Forward {
	...
	ExtentSparkReporter sparkreporter = new ExtentSparkReporter("Forward.html");
	...
	public void testcase01() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Syncing Archive 0 / 46']")));
		Actions act = new Actions(driver);
		WebElement e = driver.findElement(By.xpath("//span[text()='RE: Main msg']"));
		//WebElement e = driver.findElement(By.xpath("//span[text()='Fwd: Main msg']"));
		act.moveToElement(e).build().perform();
		Thread.sleep(300);
		driver.findElement(By.xpath("(//img[@alt='Forward'])[1]")).click();
		Thread.sleep(200);
		String d = driver.findElement(By.xpath("(//p[text()='Forward Mail'])[1]")).getText(); 
		Assert.assertEquals("Forward Mail", d);
		Thread.sleep(500);
		

		ExtentTest test = reports.createTest("Forward mail");
	...
	public void testcase02() throws InterruptedException {
		Thread.sleep(1000);
		WebElement toField = driver.findElement(By.xpath("(//div[@class='css-19bb58m'])[1]"));
		toField.click();
	...
	public void testcase03() throws InterruptedException {
		...
		driver.findElement(By.xpath("(//img[@alt='Forward'])[1]")).click();
		Thread.sleep(200);
		String a = driver.findElement(By.xpath("(//p[text()='Forward Mail'])[1]")).getText();
	...
	public void testcase04() throws InterruptedException {
		...
		Thread.sleep(1000);
		String c = driver.findElement(By.xpath("(//p[text()='Forward Mail'])[1]")).getText();
		Assert.assertEquals("Forward Mail", c);
		Thread.sleep(500);
		...
		test.info("Expected Results: It should close the confirmation box and should display the Forward screen");
		test.pass(c);
		test.log(Status.PASS, "Actual Results: It is closing the confirmation box and displaying Forward screen");
		test.pass("Test Case: Test case passed");
		Thread.sleep(1000);
	...
	public void testcase06() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on send button");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
	...
	public void testcase07() throws InterruptedException {
		...
		Thread.sleep(1000);
		String c = b.getText();
		//Assert.assertEquals("1 - 100 of 377", c);
		Assert.assertEquals("1 - 74 of 74", c);
		Thread.sleep(500);
		WebDriverWait wait3 = new WebDriverWait(driver, Duration.ofSeconds(70));
		wait3.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("(//p[text()='Forward Mail'])[1]")));
		Thread.sleep(2000);

		ExtentTest test = reports.createTest("Forward any mail");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
...
//		Assert.assertEquals("1 - 100 of 377", c);
		...
		ExtentTest test = reports.createTest("Forward any mail by CC");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
	...
	public void testcase09() throws InterruptedException {
		...
		Thread.sleep(300);
		WebElement toField1 = driver.findElement(By.xpath("(//div[@class='css-19bb58m'])[3]"));
		toField1.click();
		actions.moveToElement(toField1).click().sendKeys("test.te@te.in").sendKeys(Keys.ENTER).build().perform();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//br[@class='ProseMirror-trailingBreak'])[1]")).sendKeys("Test Test Test 1");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//button[text()='Send ']")).click();
		...
		ExtentTest test = reports.createTest("Forward any mail by BCC");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
	...
	public void testcase10() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on dismiss Forward button");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
		test.info("Enter To mail");
		test.info("Enter text in the input field");
		test.info("Click on dismiss Forward button");
	...
	public void testcase11() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on dismiss Forward button and click on save as draft option");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.info("Enter To mail");
	...
	public void testcase12() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on dismiss Forward button and click on discard option");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
	...
	public void testcase13() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on dismiss Forward button and click on cancel option");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
		...
		test.info("Expected Results: It should close the confirmation box and should display Forward Mail window");
		test.pass(c);
		test.log(Status.PASS, "Actual Results: It is closing the confirmation box and displaying Forward Mail window");
		test.pass("Test Case: Test case passed");
		Thread.sleep(1000);
	...
	public void testcase14() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on dismiss Forward button and click on close button");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
	...
	public void testcase18() throws InterruptedException, AWTException {
		...
		Thread.sleep(1000);
		String d = b.getText();
		//Assert.assertEquals("1 - 100 of 377", d);
		Assert.assertEquals("1 - 74 of 74", c);
		Thread.sleep(500);
	...
	public void testcase19() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on Forward and click on outside of the Forward screen");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(d);
		test.info("Click on outside of the Forward screen");
		test.info("Expected Results: It should display confirmation box");
		test.pass(b);
		test.log(Status.PASS, "Actual Results: It is displaying confirmation box");
		test.pass("Test Case: Test case passed");
	...
	public void testcase20() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on outside of the Forward screen and click on save as draft option");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.info("Enter To mail");
	...
	public void testcase21() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on outside of the Forward screen and click on discard option");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
	...
	public void testcase22() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on outside of the Forward screen and click on cancel option");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
	...
	public void testcase23() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on outside of the Forward screen and click on close button");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Forward button");
		test.pass(a);
