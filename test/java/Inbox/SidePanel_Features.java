...
public class SidePanel_Features {
	WebDriver driver;
	ExtentReports reports = new ExtentReports();
	ExtentSparkReporter sparkreporter = new ExtentSparkReporter("SidePanel_Features.html");
	...
	public void testcase01() throws InterruptedException {
		...
		Thread.sleep(300);
		WebElement a = driver.findElement(By.xpath("(//img[@src='layouts/sidepanel-active.svg'])[1]"));

		ExtentTest test = reports.createTest("Click on side panel");
		test.info("Use login successfully vith valid credentials");
		test.info("Click on side panel view option");
		test.info("Expected Results: It should activate the side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
		} else {
			test.fail("It is not activating the side panel list view");
		}
		test.log(Status.PASS, "Actual Results: It is activating the side panel list view");
	...
	public void testcase02() throws InterruptedException {
		...
		test.info("Click on side panel list view option");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
		} else {
			test.fail("It is not activating the side panel list view");
		}
		test.info("Click on delete option of the mail");
	...
	public void testcase03() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Adding flag to mail");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view button");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
		} else {
			test.fail("It is not activating the side panel list view");
		...
		test.info("Expected Results: It should add flag to that mail");
		if (b.isDisplayed()) {
			test.pass("It is flagging that mail");
		} else {
			test.fail("It is not flagging that mail");
		}
		test.log(Status.PASS, "Actual Results: It is flagging that mail");
		test.pass("Test Case: Test case passed");
	}
	...
	public void testcase04() throws InterruptedException {
		...
		test.info("Click on remove flag option");
		test.info("Expected Results: It should remove flag to that mail");
		if (b.isDisplayed()) {
			test.pass("It is removing flag to that mail");
		} else {
			test.fail("It is not removing flag to that mail");
		}
	...
	public void testcase05() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Marking the mail as respond later");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
		} else {
			test.fail("It is not activating the side panel list view");
		}
		test.info("Click on Mark as Respond later option");
	...
	public void testcase06() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Removing respond later to the mail");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
		...
		test.info("Expected Results: It should remove respond later to the mail");
		if (b.isDisplayed()) {
	...
	public void testcase07() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Marking the mail as unread");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
	...
	public void testcase08() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Marking the mail as read");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
	...
	public void testcase09() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on reply with attachment option");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
		...
		test.info("Click on reply with attachment option");
		test.info("Expected Results: It should display reply mail screen");
		test.pass(b);
		test.log(Status.PASS, "Actual Results: It is displaying the reply mail screen");
		test.pass("Test Case: Test case passed");
	}
	...
	public void testcase10() throws InterruptedException {
		Thread.sleep(300);
		driver.findElement(By.xpath("(//*[name()='svg' and @class='cursor-pointer'])[2]")).click();
		Thread.sleep(300);
		...
		ExtentTest test = reports.createTest("Reply all with attachments");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
		...
		test.pass("Test Case: Test case pass");
	}
	...
	public void testcase11() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on reply mail");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
	...
	public void testcase12() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on replay all mail");
		test.info("User login successfully with valid credentials");
		test.info("Click on side panel list view");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
	...
	public void testcase13() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Click on forward mail option");
		test.info("User login successfully with valid credentials");
		test.info("Click on side list panel");
		if (a.isDisplayed()) {
			test.pass("It is activating the side panel list view");
		} else {
			test.fail("It is not activating the side panel list view");
		...
		test.info("Expected Results: It should display froward mail screen");
		test.pass(b);
	...
	public void testcase14() throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[text()='Discard']")).click();
		Thread.sleep(500);
		WebElement c = driver.findElement(By.xpath("(//img[@src='layouts/sidepanel-active.svg'])[1]"));
		Thread.sleep(300);
		...
		Thread.sleep(500);
		driver.findElement(By.xpath("//div[text()='20 per page']")).click();
		Thread.sleep(500);
		String b = driver.findElement(By.xpath("(//div[@class='font-semibold cursor-pointer'])[1]")).getText();
