...
public class Reply_All {
	...
	public void testcase01() throws InterruptedException {
		...
		//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Syncing INBOX 300 / 377']")));
		...
		Thread.sleep(300);
		driver.findElement(By.xpath("(//img[@alt='Reply All'])[1]")).click();
		Thread.sleep(200);
		String d = driver.findElement(By.xpath("(//p[text()='Reply Mail'])[1]")).getText(); 
		Assert.assertEquals("Reply Mail", d);
		Thread.sleep(500);

		ExtentTest test = reports.createTest("Reply All mail");
	...
	public void testcase07() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Reply All any mail");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Reply All button");
		test.pass(a);
...
//		Assert.assertEquals("1 - 100 of 377", c);
		...
		ExtentTest test = reports.createTest("Reply All any mail by CC");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Reply All button");
		test.pass(a);
	...
	public void testcase09() throws InterruptedException {
		...
		ExtentTest test = reports.createTest("Reply All any mail by BCC");
		test.info("Login the user successfully with valid credentials");
		test.info("Place the cursur on any mail");
		test.info("Click on Reply All button");
		test.pass(a);
